...
// Garante instância única (evita conflito de porta e polling do Telegram)
...
// Usa Chromium do Puppeteer por padrão no Electron (sem depender de navegador do sistema)
// Se quiser forçar navegador do sistema, defina PUPPETEER_USE_SYSTEM=1 no ambiente.
if (!process.env.PUPPETEER_USE_SYSTEM) {
  process.env.PUPPETEER_USE_SYSTEM = '0';
}
